                ...
                <form class="col-md-6 image-uplode d-inline-block border shadow-lg rounded p-2 mt-5" action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-group">
                          ...
                          <input type="text" name="members" class="form-control" id="members" placeholder="Members" required>
                          <input type="text" name="leader" class="form-control" id="leader" placeholder="Leader" required>
                        </div>
                    <div class="m-5">
