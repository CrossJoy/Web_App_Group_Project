        ...
        <div class="hero-content display-table">
            <div class="table-cell">
                <div class="container">
                    ...
                    <p class="hero-subtitle"><span class="typed" data-typed-items="Purify Yourself, Preach Others"></span>
                    </p>
                    ...
                    <div class="col-sm-12">
                        <div class="box-shadow-full">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="about-img">
                                        <img src="assets/img/folio1.png" class="img-fluid rounded b-shadow-a"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="about-me pt-4 pt-md-0">
                                        ...
                                        <p class="lead">
                                            STEADFAST (Students Facilitator Team) isone of the oldest clubs under
                                            supervision of
                                        ...
                                        <p class="lead">
                                            ...
                                            establishment is to create a team of elite students to asist the young
                                            generation
                ...
                <div class="row">
                    <div class="col-sm-3 col-lg-3">
                        <div class="counter-box counter-box pt-4 pt-md-0">
                            ...
                            <div class="counter-num">
                                <p data-purecounter-start="0" data-purecounter-end="27" data-purecounter-duration="1"
                    ...
                    <div class="col-sm-3 col-lg-3">
                        <div class="counter-box pt-4 pt-md-0">
                            ...
                            <div class="counter-num">
                                <p data-purecounter-start="0" data-purecounter-end="217" data-purecounter-duration="1"
                                    class="counter purecounter"></p>
